...
function setup() {
  ...
  buretteLiquidColor = color(200, 107, 30, 100);//setting the colour of burette liquid
  liquidLevel = 8 * size;
  ...
  changetint = color(255, 135, 50);//Defining the net at starting
  aftercolour = color(98, 46, 10);//Defining the net colour after titration
